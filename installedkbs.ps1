# PowerShell script to list all installed security-related KBs on a Windows 10 or 11 machine in a table format, including KB article ID, title, and description

$Session = New-Object -ComObject Microsoft.Update.Session
$Searcher = $Session.CreateUpdateSearcher()
$Criteria = "IsInstalled=1 and Type='Software' and CategoryIDs contains 'E6CF1350-C01B-414D-A61F-263D14D133B4'"
$SearchResult = $Searcher.Search($Criteria).Updates

if($SearchResult.Count -eq 0){
    Write-Host "No installed security-related KBs found"
}
else{
    $KBUpdates = @()
